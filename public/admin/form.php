...
<div class="bg-white rounded-xl p-6 shadow-sm border-2 border-primary/20 mt-4">
  <div class="flex items-center justify-between">
    <div>
      <h3 class="text-xl font-bold text-gray-800">🎉 Diplomatic Event Portal</h3>
      <p class="text-gray-600 mt-1">Manage event registrations, view schedules, and track attendees</p>
    </div>
    <a href="parliamentaryservices.html" class="bg-primary text-white px-6 py-3 rounded-lg font-semibold hover:bg-primary/90 transition-all flex items-center gap-2">
